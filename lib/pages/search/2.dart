        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: medicine['itemImage'] != null
                  ? ClipRRect(
                      borderRadius: BorderRadius.circular(10),
                      child: Image.network(
                        '${medicine['itemImage']}',
                        fit: BoxFit.cover, // 여기에 BoxFit을 지정
                      ),
                    )
                  : Container(),
            ),
            ...
            Container(
              margin: const EdgeInsets.only(
                  top: 18, left: 18, right: 18), // 좌우 여백 추가
...
// 이상반응
            Visibility(
              visible: medicine['seQesitm'] != null &&
                  medicine['seQesitm'].isNotEmpty,
              child: Container(
                margin: const EdgeInsets.only(
                    top: 18, left: 18, right: 18), // 좌우 여백 추가
                decoration: BoxDecoration(
            ...
            Visibility(
              ...
              child: Container(
                margin: const EdgeInsets.only(
                    top: 18, left: 18, right: 18, bottom: 30), // 좌우 여백 추가
                decoration: BoxDecoration(
                  color: Colors.white,
                  borderRadius: BorderRadius.circular(10),
                  boxShadow: [
